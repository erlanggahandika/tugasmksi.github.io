...
$posts = mysqli_query($conn, "SELECT * FROM news");
                ...
                <div class="masonry-blog clearfix">
                    <div class="left-side">
                        <div class="masonry-box post-media">
                             <img src="rsz_b1.jpg" alt="" class="img-fluid">
                             <div class="shadoweffect">
                                <div class="shadow-desc">
                                    <div class="blog-meta">
                                        <span class="bg-aqua"><a href="post.php?id=<?php echo  $d['id']; ?>" title=""><?php echo $d['category'];?></a></span>
                                        <h4><a href="post.php?id=<?php echo  $d['id']; ?>" title=""><?php echo $d['title']; ?></a></h4>
                                        <small><a href="post.php?id=<?php echo  $d['id']; ?>" title=""><?php echo $d['publish']; ?></a></small>
                                        <small><a href="post.php?id=<?php echo  $d['id']; ?>" title=""><?php echo $d['author']; ?></a></small>
                                    </div><!-- end meta -->
                                </div><!-- end shadow-desc -->
                            </div><!-- end shadow -->
                        </div><!-- end post-media -->
